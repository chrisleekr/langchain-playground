...
import bedrockKnowledgeBaseQueryPost from '@/api/document/query/bedrock-knowledge-base.post';
...
const documentRouter: FastifyPluginAsync = async fastify => {
  ...
  fastify.post('/query/parent', createRouteSchema({ body: PostQuery }), queryPost());
  fastify.post('/query/bedrock-knowledge-base', createRouteSchema({ body: PostQuery }), bedrockKnowledgeBaseQueryPost());
};
